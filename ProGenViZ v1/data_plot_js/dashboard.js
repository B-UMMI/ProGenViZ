...
var increment=intervalSize;
for (i=0;i<numberOfBars;i++){
    if (i==0){
        strSize='0-'+String(intervalSize.toFixed(0));
        ArrayOfSizes[strSize]={};
    }
    else{
        strSize=String(increment.toFixed(0))+'-'+String((intervalSize+increment).toFixed(0));
        ArrayOfSizes[strSize]={};
        increment=intervalSize+increment;
    }
}
