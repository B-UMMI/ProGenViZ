...
<!--#######################################################END OF PHP POST AND SESSIONS DEALING. END OF INPUT PROCESSING#####################################-->
  ...
  <div id="sidebar-wrapper">
    ...
    <li><hr></hr></li>
    <li style="color:white">Compare Method in use: 
    <?php
...
<div class="modal fade" id="myModalShowGFFBLAST" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">Only files with information on sequences can be used with BLAST. <br>GFF files do not have sequence information.
</div>
        <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="myModalFiles" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Upload Complete</h4>
      </div>
      <div class="modal-body">
        <?php
          ...
          for($i=0; $i < $numFiles;$i++){
              $filenumber=$i+1;
              echo "<td>The file ".$_SESSION['FilesUploaded'][$i]." has been uploaded."."<br>";
          }
...
<div class="modal fade" id="myModalShowIdentifier" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h5> Please type a name to identify the sequence.</h5>
        <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
          $numFiles=count($_SESSION['array_path[]']);
          echo '<label for="GenomeToSearch">Choose a Genome Position To Search:</label><select class="form-control" name="GenomeToSearch">';
          for($i=0; $i < $numFiles;$i++){
              $filenumber=$i+1;
