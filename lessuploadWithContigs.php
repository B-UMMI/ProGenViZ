    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php
                    ...
                    echo"<form enctype='multipart/form-data' action='lessuploadWithContigs.php' method='POST'>
                        <input type='submit'  class='btn btn-link btn-lg' name='bygene' value='Compare Genes By Name With Next Position File' />
                ...
                echo "</form>";
                     ...
                     echo"<form enctype='multipart/form-data' action='lessuploadWithContigs.php' method='POST'>
                        <input type='submit' class='btn btn-link btn-lg' name='byfunction' value='Compare Genes By Function With Next Position File' />
